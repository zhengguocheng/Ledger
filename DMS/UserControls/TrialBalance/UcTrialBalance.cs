...
{
    public partial class UcTrialBalance : LedgerSheetBaseTrialBal
    {
        ...
        public UcTrialBalance(long _docItemID, Tags.TagType type)
        {
            InitializeComponent();
            ...
            if(type == Tags.TagType.OpeningTrialBal)
                groupBox1.Text = "Opening Trial Balance Details";
