...
{
    public partial class UcStarDocumentList : UserControlBase
    {
        ...
        public UcStarDocumentList()
        {
            InitializeComponent();
            this.Caption = "Starred Document Report";
        }

        private void UcStarDocumentList_Load(object sender, EventArgs e)
        {
        ...
        void LoadGrid()
        {
            docList = repCntr.FindAllTagged(Tags.TagType.Star);
