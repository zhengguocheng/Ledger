...
namespace Ledgers
{
    public partial class UcLedgerClientList : UserControlBase
    {
        ...
        public void SaveColumnSetting()
        {
            ...
            //Ledgers.Properties.Settings.Default.ClientListHiddenColumns = sb.ToString();
        ...
        {
            DisplayManager.LoadControl(new Ledgers.UcAccount());
        }
